      ...
      <section className="expand-app">
        <div className="ios-container">
          ...
          <p className="expand-intro">
            Your business is unique, and your app should be, too. At AppAspect,
            we specialize in building apps that reflect your brand's identity
          ...
          <div className="expand-steps">
            ...
            <ol>
              <li>
                <strong>In-Depth Research:</strong> We start by understanding your business and industry.
              </li>

              <li>
                <strong>UI/UX Design:</strong> Our intuitive designs focus on delivering a seamless user experience.
              </li>

              <li>
                <strong>Development:</strong> We use the latest tech to bring your app idea to life.
              </li>

              <li>
                <strong>Launch & Beyond:</strong> We don't just launch your app; we stick around to ensure its success.
              </li>
            </ol>
