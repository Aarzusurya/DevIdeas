    ...
    <div className="about-container">
      ...
      <section className="values-section">
        ...
        <div className="values-grid">
          ...
          <div className="value-card">
            <img src="https://cdn-icons-png.flaticon.com/512/847/847969.png" alt="integrity"/>
            <h4>Integrity</h4>
            <p>We act with honesty, fairness and transparency in all we do.</p>
          </div>

          <div className="value-card">
            <img src="https://cdn-icons-png.flaticon.com/512/1828/1828884.png" alt="excellence"/>
            <h4>Excellence</h4>
            <p>We strive for the highest quality and set benchmarks in every project.</p>
          </div>

          <div className="value-card">
            <img src="https://cdn-icons-png.flaticon.com/512/1077/1077114.png" alt="client"/>
            <h4>Client-Centricity</h4>
            <p>We put customer success at the heart of every solution.</p>
          </div>

          <div className="value-card">
            <img src="https://cdn-icons-png.flaticon.com/512/906/906334.png" alt="team"/>
            <h4>Teamwork</h4>
            <p>Collaboration and mutual respect drive our success.</p>
          </div>

          <div className="value-card">
            <img src="https://cdn-icons-png.flaticon.com/512/2991/2991108.png" alt="learning"/>
            <h4>Continuous Learning</h4>
            <p>We stay ahead by exploring AI, Vibe Coding and next-generation tech trends.</p>
          </div>

          <div className="value-card">
            <img src="https://cdn-icons-png.flaticon.com/512/942/942799.png" alt="impact"/>
            <h4>Impact</h4>
            <p>Our solutions create a positive difference for clients, teams and society.</p>
          </div>
      ...
      <section className="choose-section">
        ...
        <div className="choose-grid">
          ...
          <div className="choose-card">
            <img src="https://cdn-icons-png.flaticon.com/512/3135/3135715.png" alt="expert"/>
            <h4>Trusted Expertise</h4>
            <p>14+ years in mobile and web development</p>
          </div>

          <div className="choose-card">
            <img src="https://cdn-icons-png.flaticon.com/512/4149/4149676.png" alt="future"/>
            <h4>Future-Ready Technologies</h4>
            <p>Embracing AI Agents and automation</p>
          </div>

          <div className="choose-card">
            <img src="https://cdn-icons-png.flaticon.com/512/1534/1534959.png" alt="client"/>
            <h4>Client Success Focus</h4>
            <p>Long-term partnerships that deliver results</p>
          </div>
